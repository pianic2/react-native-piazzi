...
/>`}
      ...
      {/* ========================================================= */}
      {/* 6 — COMPONENTI TEMATIZZATI */}
      {/* ========================================================= */}
      <Card style={{ marginTop: 20 }}>
        <Heading level={3}>6. Componenti Che Usano il Tema</Heading>
        <Divider />

        <P>
          Ogni componente della libreria utilizza automaticamente i colori del
          tema, senza bisogno di configurazioni manuali.
        </P>

        <TextGroup spacing={10} style={{ marginTop: 12 }}>
          <P>• <B>Button</B>: usa <CodeInline>colors[type]</CodeInline></P>
          <P>• <B>Card</B>: usa <CodeInline>colors.surface</CodeInline></P>
          <P>• <B>P / B / Small</B>: usano <CodeInline>colors.text</CodeInline></P>
          <P>• <B>Input</B>: usa <CodeInline>colors.input.border</CodeInline></P>
          <P>• <B>ThemedBackground</B>: usa <CodeInline>colors.background</CodeInline></P>
        </TextGroup>
      </Card>

      {/* ========================================================= */}
      {/* 7 — COLOR SCHEME CUSTOM */}
      {/* ========================================================= */}
      <Card style={{ marginTop: 20 }}>
        <Heading level={3}>7. Creare Nuove Varianti Colore</Heading>
        <Divider />

        <P>
          Il tema supporta facilmente l’aggiunta di nuove varianti, come{" "}
          <B>info</B> o <B>successAlt</B>, semplicemente aggiungendole in extendTheme().
        </P>
  ...
  info: {
    ...
    border: "#3182CE"
      ...
      {/* ========================================================= */}
      <Card style={{ marginTop: 20 }}>
        <Heading level={3}>8. Struttura Interna del Tema</Heading>
        <Divider />

        <P>
          Il file base contiene tutti i token necessari, organizzati in categorie:
        </P>

        <TextGroup spacing={8} style={{ marginTop: 10 }}>
          <Small>• background / surface</Small>
          <Small>• text</Small>
          <Small>• primary / secondary / outline</Small>
          <Small>• success / warning / danger</Small>
          <Small>• estendibile con varianti custom</Small>
        </TextGroup>

        <Heading level={4} style={{ marginTop: 20 }}>Estratto</Heading>
